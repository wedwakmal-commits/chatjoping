    ...
    return (
        <div className="fixed inset-0 bg-black bg-opacity-50 z-50 flex justify-center items-center">
            <div className="bg-white dark:bg-gray-800 rounded-lg shadow-xl w-full max-w-lg p-6 m-4">
                <h2 className="text-2xl font-bold mb-4 text-gray-800 dark:text-white">إنشاء مهمة جديدة</h2>
                <form onSubmit={handleSubmit}>
                    <div className="mb-4">
                        <label htmlFor="title" className="block text-sm font-medium text-gray-700 dark:text-gray-300">اسم المهمة</label>
                    ...
                    <div className="mb-4">
                        <label htmlFor="description" className="block text-sm font-medium text-gray-700 dark:text-gray-300">وصف المهمة</label>
                     ...
                     <div className="mb-4">
                        <label htmlFor="project" className="block text-sm font-medium text-gray-700 dark:text-gray-300">المشروع</label>
                        <select
                            id="project"
                            value={projectId || ''}
                    ...
                    <div className="mb-4">
                        <label htmlFor="assignees" className="block text-sm font-medium text-gray-700 dark:text-gray-300">تعيين إلى</label>
                        <select
                            id="assignees"
                            multiple
                            value={assigneeIds}
                    ...
                    <div className="flex justify-end space-x-2 space-x-reverse">
                        ...
                        <button type="submit" className="px-4 py-2 bg-indigo-600 text-white rounded-md hover:bg-indigo-700">إنشاء مهمة</button>
                    </div>
                </form>
            </div>
        </div>
